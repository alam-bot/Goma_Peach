...
from PARINDA.misc import db
from PARINDA.utils.database import get_assistant, get_authuser_names, get_cmode
from PARINDA.utils.decorators import ActualAdminCB, AdminActual, language
from PARINDA.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await parinda.stop_stream_force(chat_id)
        except:
            pass
